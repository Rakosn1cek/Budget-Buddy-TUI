...
​Status
​:sparkles: Feature Complete: All core functionality (tracking, summaries, goals, recurring payments) is implemented.
:hammer_and_wrench: Stable: Specifically configured to run reliably on Termux's standard Python 3.12 environment without complex build dependencies.
​Features
...
​Contributions are welcome! If you have an idea for a new feature, a bug report, or a code improvement, please feel free to:
